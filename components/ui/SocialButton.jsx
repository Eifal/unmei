...
const SocialButtons = () => {
  return (
    <div className="flex justify-center space-x-4">
      <button type="button" aria-label="Twitter" className="bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-full w-10 h-10 inline-flex items-center justify-center dark:focus:ring-[#1da1f2]/55">
        <a href='https://x.com/_eifvl' aria-label="Visit X Website" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}>
      ...
      <button type="button" aria-label="Github" className="bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-full w-10 h-10 inline-flex items-center justify-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30">
        <a href='https://github.com/Eifal' aria-label="Visit Github Website" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}>
      ...
      <button type="button" aria-label="Discord" className="bg-[#5865F2] hover:bg-[#5865F2]/90 focus:ring-4 focus:outline-none focus:ring-[#5865F2]/50 font-medium rounded-full w-10 h-10 inline-flex items-center justify-center dark:focus:ring-[#5865F2]/55">
        <a href='https://discordapp.com/users/888941811224150046/' aria-label="Visit Discord Website" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}>
